                    ...
                    <CardBody>
                        <form className=" flex flex-col gap-4">
                            ...
                            <p style={{ textAlign: 'center' }}>
                                <span style={{ display: 'inline-block', width: '100%', maxWidth: '100px', borderBottom: '1px solid #000', verticalAlign: 'middle' }}></span>
                                <span style={{ marginRight: '10px', marginLeft: '10px' }}>or</span>
                                <span style={{ display: 'inline-block', width: '100%', maxWidth: '100px', borderBottom: '1px solid #000', verticalAlign: 'middle' }}></span>
                            </p>

                            <Button onClick={googleSignIn} color="blue" fullWidth>
                                Login with Google
                            </Button>
