...
function Comment({ addComment, commentText, setcommentText, allComment, setAllComment, deleteComment, fullName, setFullName, currentUser }) {
            ...
            <div className="max-w-2xl mx-auto px-4">
                ...
                <article className="p-6 mb-6 text-base rounded-lg" style={{ background: mode === 'dark' ? '#353b48' : 'rgb(226, 232, 240)' }}>
                    {allComment.map((item, index) => {
                        const { fullName, date, commentText, userId, id } = item;
                        return (
                            <div key={index}>
